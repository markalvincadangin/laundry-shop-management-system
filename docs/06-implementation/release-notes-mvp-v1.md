...
- **Backend:** Java 21, Spring Boot 3.5+, PostgreSQL 16, Flyway (Isolated `db/dev-migration` profiles), JWT
- **Frontend:** Next.js 15+, React 19, TypeScript, Tailwind CSS
- **Infrastructure:** Standalone Windows Application (`.exe`) + Ngrok / Cloudflare Tunnel (`cloudflared`)
