...
| **1.3** | The system shall allow staff to update and track the exact status of a laundry order (e.g., Received, Washing, Drying, Folding, Ready for Pickup, Released). | ☑ Mandatory<br>☐ Desirable |
