...
The study is based on a semi-structured interview and on-site observation with the owner and staff. Findings serve as the foundation for requirements definition, system design, and implementation.
...
**Manual and Time-Consuming Record Keeping** — Recording orders, payments, and sales manually requires significant effort from owner and staff.
...
**Lack of Automated Reporting** — Income tracking is manual; the owner lacks automated daily, monthly, or yearly reports.
...
The absence of automated reporting makes it difficult for the owner to evaluate performance, compare income across periods, and make informed decisions.
...
The owner has expressed willingness to adopt a simple computer-based system. A system-based solution will improve efficiency, enhance customer service, and support sustainable growth.
