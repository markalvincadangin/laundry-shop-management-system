...
public abstract class AbstractIntegrationTest {
    ...
    private static final String TEST_DB_USERNAME =
        "laundry_user_" + UUID.randomUUID().toString().replace("-", "").substring(0, 8);
    private static final String TEST_DB_PASSWORD =
        "pw_" + UUID.randomUUID().toString().replace("-", "") + UUID.randomUUID().toString().replace("-", "");
